...
<style media="screen">
  ...
  .media-body .col-sm-2 { padding: 0 5px; }
  .media_file {
      height: 100px;
      background-repeat: no-repeat; background-position: top center; background-size: cover; }
  .thumbnail { border: 1px solid #000; padding: 5px; margin-top: 10px; }
  .delete_media { position: absolute; top: 5px; right: 5px; color: #ff0000; }

 #progress-wrp { display: none; border-radius: 4px;margin: 10px;text-align: left;background: #fff;box-shadow: inset 1px 3px 6px rgba(0, 0, 0, 0.12);}
 #progress-wrp .progress-bar{ color: #fff; height: 20px;border-radius: 3px;background-color: #32CD32;width: 0;box-shadow: inset 1px 1px 10px rgba(0, 0, 0, 0.11);}

 .media_list { margin: 0; padding: 0; list-style-type: none; }
 .media_list li { width: 16.666667%; float: left; padding: 0 3px; }
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4>Media <button class="btn btn-info btn-sm pull-right media_btn" type="button" data-target="#media_file_modal" data-toggle="modal">Upload Files</button>
                </h4>
                    ...
                    <ul class="media_list">
                        ...
                        <li>
                            ...
                            <div class="thumbnail" style="display: block; position: relative;">
                                <a class="delete_media" href='javascript:;' onchange="deleteImage({{$media->id}})"></a>
                          ...
                          <input type="checkbox" name="media" value="{{Crypt::encrypt($media->id)}}">
                        </li>
                        @endforeach
                    </ul>
                  @else
...
<!-- Modal -->
<div class="modal fade" id="media_file_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="{{url('/admin/media/save')}}" class="" id="media_form" enctype="multipart/form-data" method="post">
