                    ...
                    <div class="tab-pane active" id="home" role="tabpanel">
                        <div class="card-body">
                            <div class="profiletimeline">
                                <div class="sl-item">
                                    <div class="sl-left"><img src="{{asset('/admin')}}/assets/images/users/1.jpg"
                                                              alt="user"
                                ...
                                <hr>
                                <div class="sl-item">
                                    <div class="sl-left"><img src="{{asset('/admin')}}/assets/images/users/2.jpg"
                                                              alt="user"
                                                              class="img-circle"/></div>
                                    <div class="sl-right">
                                        <div><a href="#" class="link">John Doe</a> <span
                                ...
                                <hr>
                                <div class="sl-item">
                                    <div class="sl-left"><img src="{{asset('/admin')}}/assets/images/users/3.jpg"
                                                              alt="user"
                                                              class="img-circle"/></div>
                                    <div class="sl-right">
                                        <div><a href="#" class="link">John Doe</a> <span
                                ...
                                <hr>
                                <div class="sl-item">
                                    <div class="sl-left"><img src="{{asset('/admin')}}/assets/images/users/4.jpg"
                                                              alt="user"
                                                              class="img-circle"/></div>
                                    <div class="sl-right">
                                        <div><a href="#" class="link">John Doe</a> <span
